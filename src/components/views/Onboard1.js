    ...
    render() {
        ...
        return (
            <View style={{width:'100%',height:'100%',justifyContent : 'center'}}>
                <Image source={require('../../images/beerbg.jpg') }  resizeMode="cover" style={{position:'absolute',top:0,left:0,width:'100%',height:'100%'}}/>
                ...
                <View style={{flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: 0}}>
                    ...
                    <Text style={{
                        ...
                        marginBottom : 20,
                        backgroundColor : 'transparent'
                    }}>Earn points for every purchase and each time you check-in.</Text>
